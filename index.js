...
const celsiusTab = document.querySelector("[data-celsius]");
const fahrenheitTab = document.querySelector("[data-fahrenheit]");
...
let currentTemperatureUnit = celsiusTab;
const API_KEY = "d1845658f92b31c64bd94f06f7188c9c";

// Setting default tab
currentTab.classList.add("current-tab");
currentTemperatureUnit.classList.add("current-tab");
...
function switchTemperatureUnit(clickedTab) {
  if (clickedTab !== currentTemperatureUnit) {
    currentTemperatureUnit.classList.remove("current-tab");
    currentTemperatureUnit = clickedTab;
    currentTemperatureUnit.classList.add("current-tab");
...
celsiusTab.addEventListener("click", () => {
    switchTemperatureUnit(celsiusTab);
});

fahrenheitTab.addEventListener("click", () => {
    switchTemperatureUnit(fahrenheitTab);
});
...
// Add a global variable to store the current temperature unit (default to Celsius)
